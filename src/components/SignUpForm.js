...
class SignUpForm extends React.Component {
  ...
  onSubmit = (e) => {
    ...
    formData.append(
      'user[partner_birthday]',
      new Date(this.state.partner_birthday),
    );
  ...
  render() {
    ...
    return (
      <div style={{ marginTop: '6%', textAlign: 'center' }}>
        <Segment
          raised
          style={{ margin: '3% 6% 3%', textAlign: 'center' }}
        >
          <Form onSubmit={this.onSubmit}>
            <Form.Group
              widths="equal"
              style={{ margin: '1% 5% 0% 5%' }}
            >
              <Form.Field required>
                <Form.Input
                  label="First Name"
                ...
                <Form.Input
                  ...
                  placeholder={
                    this.state.first_name !== ''
                      ? `${this.state.first_name.toLowerCase()}${this.state.last_name.toLowerCase()} perhaps?`
                      : ''
                  }
                  name="username"
...
const mdp = (dispatch) => {
  return {
    newUser: (newUserObj, history, newEvent) =>
      dispatch(newUser(newUserObj, history, newEvent)),
